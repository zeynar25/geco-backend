...
public class NotificationController extends AbstractController {
    ...
    @Operation(
        ...
        description = "Retrieve all notifications for the logged-in user with pagination. Can optionally filter by read status."
    )
    @GetMapping
    public ResponseEntity<Page<Notification>> getMyNotifications(
        ...
        Page<Notification> notifications = notificationService.getMyNotifications(isRead, page, size);
        return ResponseEntity.ok(notifications);
    }
